...
Download the signed release archive from [GitHub Releases](https://github.com/smallyunet/agentore/releases/latest). The v0.0.5 archive is a universal macOS app for Apple Silicon and Intel Macs. It uses an ad-hoc code signature and is not notarized.
